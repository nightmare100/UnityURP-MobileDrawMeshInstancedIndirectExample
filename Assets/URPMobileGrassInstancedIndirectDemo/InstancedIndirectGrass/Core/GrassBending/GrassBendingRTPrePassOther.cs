...
public class GrassBendingRTPrePassOther : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        {
            if (!InstancedIndirectGrassRendererOther.instance)
            {
                Debug.LogWarning("InstancedIndirectGrassRendererOther not found, abort GrassBendingRTPrePass's Execute");
                return;
            }
            ...
            Matrix4x4 viewMatrix = Matrix4x4.TRS(InstancedIndirectGrassRendererOther.instance.transform.position + new Vector3(0, 1, 0),Quaternion.LookRotation(-Vector3.up), new Vector3(1,1,-1)).inverse;

            //ortho camera with 1:1 aspect, size = 50
            float sizeX = InstancedIndirectGrassRendererOther.instance.transform.localScale.x;
            float sizeZ = InstancedIndirectGrassRendererOther.instance.transform.localScale.z;
